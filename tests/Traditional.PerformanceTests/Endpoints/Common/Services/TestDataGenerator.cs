...
#pragma warning restore S125
    ...
    {
        string dumpCommand = $"docker exec db-traditional-postgres pg_dump -U postgres-user -d postgres-traditional -f {dockerDumpFilePath}";
    ...
    private async Task RestoreDump(string dockerDumpFilePath, CancellationToken cancellationToken)
    {
        ...
        string restoreCommand = $"docker exec db-traditional-postgres psql -U postgres-user -d postgres-traditional -f {dockerDumpFilePath}";
